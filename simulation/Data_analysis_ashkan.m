...
ylabel('$\beta$ [rad/s]', 'FontWeight','bold' , 'FontSize',25)
grid on
...
legend
grid on
xlabel('$\kappa_{1} \dot{\beta} + \kappa_{2} \beta$' , 'FontWeight','bold' , 'FontSize',25)
ylabel('$\rho_{c}$', 'FontWeight','bold' , 'FontSize',25)
fig = gcf;
